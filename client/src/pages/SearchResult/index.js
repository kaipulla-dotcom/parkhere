...
class SearchResult extends Component {
  ...
  handleClickOpen = (id, address, title, href, city, state, zip, price) => {
    this.setState({
      open: true,
      title: title,
      address: address,
  ...
  handleBookClick = (id, address, title, href, city, state, zip, price) => {
    this.setState({
      title: title,
      address: address,
      href: href,
  ...
  renderMap = () => {
    ...
    loadScript(
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyBRi07WLScRfCcP0gC8tPe-7jpmrKCSBK0&callback=initMap"
    );
          ...
          return () => {
            infoWindow.setContent(
              "<img width='100px' src=" +
                ...
                this.state.cardsArray[i][0].spotType +
                "</p>"
            );
